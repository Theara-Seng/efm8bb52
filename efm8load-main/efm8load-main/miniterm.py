...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# default args can be used to override when calling run_terminal() from an other script
# e.g to create a miniterm-my-device.py
def run_terminal(port=None, baudrate=9600, rts=False, dtr=False):
    ...
    try:
        ...
        serial_instance.setDTR(dtr)
        serial_instance.setRTS(rts)
