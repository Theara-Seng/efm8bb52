...
class EFM8Loader:
    ...
    devicelist = {
                    ...
                    0x34 : ["EFM8LB1", {
                                        0x41: ["EFM8LB12F64E_QFN32" , 64*1024, 512, 512],
                                        }],
                    0x39 : ["EFM8BB52", {
                                        0x01: ["EFM8BB52F32G_QFN32"  , 32*1024, 2048, 2048],
                                        0x02: ["EFM8BB52F16G_QFN20"  , 16*1024, 2048, 2048],
                                        0x03: ["EFM8BB52F16G_TSSOP28", 16*1024, 2048, 2048],
                                        0x04: ["EFM8BB52F16G_QFN32"  , 16*1024, 2048, 2048],
                                        0x05: ["EFM8BB52F32G_TSSOP20", 32*1024, 2048, 2048],
                                        0x06: ["EFM8BB52F32G_QFN20"  , 32*1024, 2048, 2048],
                                        0x07: ["EFM8BB52F32G_TSSOP28", 32*1024, 2048, 2048],
                                        0x08: ["EFM8BB52F16G_TSSOP20", 16*1024, 2048, 2048],
                                        }]
                 }
...
def list_port():
    ...
    easier on systems with long device names
    """
    sys.stderr.write('\n> Available ports:\n')
    ports = []
...
if __name__ == "__main__":
    ...
    group.add_argument("-l", "--list-port", help="list available COM ports", action="store_true")
    ...
    argp.add_argument('-m', '--monitor', help='open serial terminal', action='store_true')
    ...
    efm8loader.close_port()

    if (args.monitor):
        print()
        miniterm.run_terminal(args.port, args.baudrate)
    elif (cmd_valid == False):
        argp.print_help()
        sys.exit(1)
